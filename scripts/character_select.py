...
class CharacterSelect(scripts.Script):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            print(f"error：custom_settings '{self.custom_settings_file}' not exists")

        try:
            self.character = self.get_config2(self.custom_character_file)
        except:
            print(f"error：custom_character '{self.custom_character_file}' not exists")
    ...
    def _before_component(self, component, **kwargs):
        ...
        with gr.Accordion(label="Character Select", open = True, elem_id=f"{'txt2img' if self.is_txt2img else 'img2img'}_preset_manager_accordion"):
            with gr.Row(equal_height = True):
    ...
    def _ui(self):
        ...
        if self.is_txt2img:
            ...
            #細節功能
            detailinput = [self.prompt_component,CharacterSelect.func01_chk,CharacterSelect.func03_chk,CharacterSelect.func04_chk]
    ...
    #細節
    def func_setting(self, oldprompt,fv1,fv3,fv4):
        self.allfuncprompt = ""
